...
public class MassUpdateNonNcpiController : Controller
{
    ...
    public MassUpdateNonNcpiController(IStringLocalizer<SharedResource> localizer)
    {
    ...
    public IActionResult Index()
    {
        ...
        return View("~/Views/FUNCTION/MassUpdateNonNcpi/View.cshtml");
    }
